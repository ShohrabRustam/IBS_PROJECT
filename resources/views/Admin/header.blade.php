...
<script>
	...
	// });*/
        ...
        <div class="container center">
            <ul>
                <li>
                    <a href="{{ URL::to('/adminhome') }} " class="navbar-brand d-flex align-items-center">
                ...
                @endif --}}
                <li> <a href="{{  URL::to('/adminhome') }}">Home </a></li>

                <li> <a href="{{ URL::to('/insurancerequest') }}">Insurance Request</a></li>
                <li> <a href="{{ URL::to('/claimrequest') }}">Claim Request</a></li>
